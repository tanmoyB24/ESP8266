...
const char *ssid = "tonmoy@M.net";  //ENTER YOUR WIFI SETTINGS
const char *password = "tan9024y";
String postData ; // post array that will be send to the website
String link = "http://192.168.1.25/biometricattendance/getdata.php"; //computer IP or the server domain
...
void setup() {
  ...
  Serial.begin(115200);
  if(!display.begin()) { // Address 0x3D for 128x64
...
uint8_t getFingerprintEnroll() {
  ...
  int p = -1;
  display.clearDisplay();
  display.drawBitmap( 34, 0, FinPr_scan_bits, FinPr_scan_width, FinPr_scan_height, SH110X_WHITE);
  display.display();
